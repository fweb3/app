    ...
    return (
      <>
        ...
        <CommonText>
          ...
          use the *<CommonLink href={getFaucetUrl()}>faucet</CommonLink> to
          receive <ColoredText>300 FWEB3</ColoredText> tokens by specifying your
          wallet address. That&apos;s enough to complete all the tasks in the
          game.
        </CommonText>
        <CommonText>
