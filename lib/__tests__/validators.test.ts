import { checkHasWonGame, currentWalletGameState } from '../polygon/validators'
import mockWalletBalance from '../polygon/__fixtures__/walletBalance.json'
import mockWalletTxs from '../polygon/__fixtures__/walletsTxs.json'
import mockTrophyTx from '../polygon/__fixtures__/trophyTsx.json'
import mockErc20Txs from '../polygon/__fixtures__/erc20Txs.json'
import mockNftsTxs from '../polygon/__fixtures__/nftsTx.json'
import {
